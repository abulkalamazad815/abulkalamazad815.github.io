                        ...
                        <ul class="nav navbar-nav menu__list">
                           ...
                           @foreach($publishedCategories as $publishedCategory) 
                            <li class="dropdown menu__item">
                                <a href="{{url('/category-view/'.$publishedCategory->id)}}" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{{$publishedCategory->categoryName}}<span class="caret"></span></a>
