        ...
        <div class="slide-visual">
            ...
            <ul class="slide-group">
             @foreach($publishedSliders as $publishedSlider)
                <li><img class="img-responsive" src="{{asset($publishedSlider->slider1Image)}}" alt="Dummy Image" /></li>
             @endforeach
            </ul>
            ...
            <div class="script-wrap">
                <ul class="script-group">
                 @foreach( $publishedSliders2 as $publishedSlider2)
                    <li><div class="inner-script"><img class="img-responsive" src="{{asset($publishedSlider2->slider2Image)}}" alt="Dummy Image" /></div></li>
                 @endforeach
                </ul>
    ...
    <div class="container">
        ...
        <div class="new_grids">
            <div class="col-md-4 new-gd-left">
                <img src="{{asset('public/frontEnd/images/Picture9.png')}}" alt=" " />
                <div class="wed-brand simpleCart_shelfItem">
                    <h4>Baby Loation</h4>
                    <h5>Flat 50% Discount</h5>
                    <p><i>$500</i> <span class="item_price">$250</span><a class="item_add hvr-outline-out button2" href="#">add to cart </a></p>
                </div>
            </div>
            ...
            <div class="col-md-4 new-gd-left">
                <a href=""><img src="{{asset('public/frontEnd/images/Picture10.jpg')}}" alt=" " /></a>
                <div class="wed-brandtwo simpleCart_shelfItem">
                    <h4 style="color: #000; margin-top:220px;font-size: 22px">Sergical Instrument</h4>
                </div>
            </div>
            <div class="clearfix"></div>
        </div>
                        ...
                        <div class="col-md-3 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset($publishedProduct->productImage)}}" alt="" class="pro-image-front" height="250" width="255">
                                    <img src="{{asset($publishedProduct->productImage)}}" alt="" class="pro-image-back" height="250" width="255">
