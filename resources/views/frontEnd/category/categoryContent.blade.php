    ...
    <div class="container">
        ...
        <div class="col-md-8 products-right">
            ...
            <div class="col-md-4 product-men no-pad-men">
                <div class="men-pro-item simpleCart_shelfItem">
                    ...
                    <div class="item-info-product ">
                        <h4><a href="{{url('/product-details')}}">Blazers</a></h4>
                        <div class="info-product-price">
                            <span class="item_price">$45.99</span>
                            <del>$69.71</del>
                        </div>
        ...
        <div class="single-pro">
            ...
            <div class="col-md-3 product-men">
                <div class="men-pro-item simpleCart_shelfItem">
                    <div class="men-thumb-item">
                        <img src="{{asset($publishedSubCategoryProduct->productImage)}}" alt="" class="pro-image-front" height="250" width="350">
                        <img src="{{asset($publishedSubCategoryProduct->productImage)}}" alt="" class="pro-image-back" height="250" width="350">
                        <div class="men-cart-pro">
                            <div class="inner-men-cart-pro">
                                <a href="{{url('/product-details/'.$publishedSubCategoryProduct->id)}}" class="link-product-add-cart">Quick View</a>
                            </div>
                        </div>
                        <span class="product-new-top">New</span>				
                    </div>
                    <div class="item-info-product ">
                        <h4><a href="{{url('/product-details/'.$publishedSubCategoryProduct->id)}}">{{$publishedSubCategoryProduct->productName}}</a></h4>
                        <div class="info-product-price">
                            <span class="item_price">BTD {{$publishedSubCategoryProduct->productPrice}}</span>
                            <del>$69.71</del>
                        </div>
                        <a href="#" class="item_add single-item hvr-outline-out button2">Add to cart</a>									
                    </div>
