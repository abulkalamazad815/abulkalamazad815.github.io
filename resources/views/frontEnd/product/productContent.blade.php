...
<div class="single">
    <div class="container">
        ...
        <div class="col-md-6 single-right-left simpleCart_shelfItem animated wow slideInRight animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInRight;">
            ...
            <br>
            <h5><span>Generic Name:</span></h5>
            <p><span class="item_price">BDT :{{$productById->productPrice}} ৳</span> <del>- $900</del>
            </p>
            <div class="rating1">
            ...
            {!! Form::open(['url'=>'/cart/add', 'method'=>'POST']) !!}
                ...
                <h5 class="text-danger">Available Stock : {{$productById->productQuantity}}</h5>
                <hr/>
