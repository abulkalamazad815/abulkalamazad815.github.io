...
<div class="row">
    <div class="col-lg-12">
        <hr/>
        <div class="well">
            {!! Form::open(['url'=>'slider2/update','method'=>'POST','class'=>'form-horizontal','enctype'=>'multipart/form-data','name'=>'editSliderForm'])!!}
            
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">Category Image</label>
                <div class="col-sm-10">
                    <input type="file" class="form-control" name="slider2Image" accept="image/" multiple>
                     <input type="hidden" value="{{$sliderById->id}}" class="form-control" name="id">
                    <img src="{{asset($sliderById->slider2Image)}}" alt="" height="150" width="150">
                    <span class="text-danger">{{$errors->has('slider2Image')? $errors->first('slider2Image'):''}}</span>
                </div>
            </div>
            <div class="form-group">
