...
<div class="row">
    <div class="col-lg-12">
        ...
        <hr/>
        <div class="well">
            {!! Form::open(['url'=>'slider2/save','method'=>'POST','class'=>'form-horizontal','enctype'=>'multipart/form-data'])!!}
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">Slider Small Image</label>
                <div class="col-sm-10">
                    <input type="file" class="form-control" name="slider2Image" accept="image/">
