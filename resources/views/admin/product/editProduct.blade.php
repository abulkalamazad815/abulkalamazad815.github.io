    ...
    <div class="col-lg-12">
        ...
        <div class="well">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea type="text" class="form-control" name="productShortDescription" rows="4">{{$productById->productShortDescription}}</textarea>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea type="text"  class="form-control" name="productLongDescription" rows="8">{{$productById->productLongDescription}}</textarea>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="file" class="form-control" name="productImage" accept="image/" multiple>
...
<script>
    ...
    document.forms['editProductForm'].elements['subcategoryId'].value = {{$productById -> subcategoryId}}
</script>
@endsection