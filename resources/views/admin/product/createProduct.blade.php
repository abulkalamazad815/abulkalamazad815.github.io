    ...
    <div class="col-lg-12">
        ...
        <div class="well">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="number" placeholder="TK:"class="form-control" name="productPrice">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea type="text" class="form-control" name="productShortDescription" rows="4"></textarea>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea type="text" class="form-control" name="productLongDescription" rows="8"></textarea>
